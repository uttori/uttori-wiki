 ...
 */
export declare function footnoteDefinition(state: import('markdown-it/index.js').StateBlock, startLine: number, endLine: number, silent: boolean): boolean;
/**
 * Converts Footnote definitions to linkable anchor tags.
 ...
 */
export declare function footnoteReferences(state: import('markdown-it/index.js').StateInline, silent: boolean): boolean;
/**
 ...
 */
export declare function configFootnoteReference(tokens: import('markdown-it/index.js').Token[], index: number, options: import('markdown-it/index.js').Options | {
    uttori: {
        footnotes: {
 ...
 */
export declare function configFootnoteOpen(tokens: import('markdown-it/index.js').Token[], index: number, options: import('markdown-it/index.js').Options, _env: object, _slf: import('markdown-it/index.js').Renderer): string;
/**
 ...
 */
export declare function configFootnoteClose(_tokens: import('markdown-it/index.js').Token[], _index: number, options: import('markdown-it/index.js').Options, _env: object, _slf: import('markdown-it/index.js').Renderer): string;
