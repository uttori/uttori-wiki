 ...
 */
export declare function getValue(token: import('markdown-it/index.js').Token, key: string): any | undefined;
/**
 ...
 */
export declare function updateValue(token: import('markdown-it/index.js').Token, key: string, value: string): void;
/**
 ...
 */
export declare function uttoriInline(state: import('markdown-it/index.js').StateCore): boolean;
