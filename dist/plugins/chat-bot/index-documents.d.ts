 ...
 */
export declare function ensureChatIndexSchema(db: import('better-sqlite3').Database, config: import('../search-provider-sqlite.js').SearchSQLiteConfig, options?: ChatIndexSchemaOptions): Promise<{
 ...
 */
export declare function indexDocumentInDatabase(db: import('better-sqlite3').Database, config: import('../search-provider-sqlite.js').SearchSQLiteConfig, embedder: OllamaEmbedder, document: import('../../wiki.js').UttoriWikiDocument): Promise<{
    chunks: number;
    skipped: boolean;
    errored: number;
}>;
