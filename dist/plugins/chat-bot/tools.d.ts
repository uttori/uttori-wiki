...
export type ChatToolExecutionContext = {
     ...
     */
    config?: import('../ai-chat-bot.js').AIChatBotConfig;
};
/**
 ...
 */
export declare function executeChatTool(name: string, args: Record<string, any>, config: import('../ai-chat-bot.js').AIChatBotConfig, context: ChatToolExecutionContext): Promise<string | ChatToolResult>;
