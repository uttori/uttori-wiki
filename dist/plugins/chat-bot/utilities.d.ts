 ...
 * @property {[string, number][]} headers The relevant headers for this node.
 ...
 */
export function markdownItAST(tokens: import("markdown-it").Token[], title: string): MarkdownASTNode[];
/**
 ...
 * @returns {{[key: string]: number}} The word count hash.
 */
 ...
 * @param {object[]} items The items to consolidate.
 ...
 */
export function consolidateSectionsByHeader(items: object[], maximumTokenCount?: number, softMinTokens?: number, minAnchorDecrease?: number): object[];
