 ...
 */
export declare function parsePath(path: string): Array<ParsedPathKey | string>;
/**
 ...
 */
export declare function prepareTarget(route: string, target: string): Array<ParsedPathKey | string>;
/**
