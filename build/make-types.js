...
const main = async () => {
  ...
  try {
    ...
    const files = [
      ...
      'plugins/diff/types.d.ts',
      'plugins/diff/diff.d.ts',
      'plugins/diff/textdiff/byteview.d.ts',
      'plugins/diff/textdiff/textdiff.d.ts',
      'plugins/diff/impl/api.d.ts',
      'plugins/diff/impl/myers.d.ts',
      'plugins/diff/impl/preprocess.d.ts',
      'plugins/diff/impl/text.d.ts',
      'plugins/diff/impl/utils.d.ts',
