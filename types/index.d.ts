...
declare module "wiki" {
    export = UttoriWiki;
    class UttoriWiki {
        constructor(config: UttoriWikiConfig, server: object);
        config: {
            site_title?: string;
            site_header?: string;
            site_footer?: string;
        ...
        buildMetadata(document: UttoriWikiDocument, path?: string, robots?: string): Promise<object>;
